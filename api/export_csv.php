...
try {
    ...
    $headers = [
        ...
        'Current Vision / الرؤية الحالية',
        'Current Mission / الرسالة الحالية',
        'Current Values / القيم',
        'Vision Action / إجراء الرؤية',
        ...
        'Planned Products / المنتجات المخططة',
        'Annual Revenue / الإيرادات السنوية',
        'Growth Rate / نسبة النمو',
        'Profit Margin / هامش الربحية',
        'Resources / الموارد',
        'Other Resource / موارد أخرى',
        'CEO / الرئيس التنفيذي',
        'Strategy Director / مدير الاستراتيجية',
        'Finance Director / مدير المالية',
        'HR Director / مدير الموارد البشرية',
        'Ops Director / مدير العمليات',
        'Consulting Contact / مسؤول التواصل',
    ...
    foreach ($records as $row) {
        ...
        fputcsv($output, [
            ...
            $row['other_resource'],
            $row['ceo'],
            $row['strategy_director'],
            $row['finance_director'],
            $row['hr_director'],
            $row['ops_director'],
            $row['consulting_contact'],
